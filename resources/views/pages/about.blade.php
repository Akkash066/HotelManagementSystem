    	...
    	<div class="container">
          ...
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              ...
              <div class="media-body py-4 px-3">
                <h3 class="heading">Exhaustive, Reliable Content</h3>
                <p>Our travel guides are editorially curated, so you can trust that they will lead you to the right path. We have invested extensive resources over the last 8 years to build exhaustive, in-depth content for all destinations</p>
          ...
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              ...
              <div class="media-body py-4 px-3">
                <h3 class="heading">Goes Around the Globe</h3>
                <p>We started with a focus on India - and are proud to be building a global company out of India - but our ambitions are global. Soon enough, you will be able to research your trip to any destination around the world on Holidify.</p>
                <p><a href="#" class="btn btn-primary">Read more</a></p>
              </div>
            </div>    
          </div>
